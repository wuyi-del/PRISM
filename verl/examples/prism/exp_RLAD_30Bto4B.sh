#!/bin/bash
# ============================================================
#  RLAD (Trust-Region-Ratio Adaptive Distillation) 30B→4B 强到弱
#
#  论文：RLAD (Chen et al., 2025)
#  公平对比配置（与 ExOPD 30B→4B Exp 8c 完全一致，除了 rlad_enabled=True）：
#    - Teacher: Qwen3-30B-A3B-Instruct-2507 (30B 强 teacher)
#    - Student: Qwen3-4B-Non-Thinking (4B 基座)
#    - T=1.0, Batch=1024, LR=1e-5, ~100 steps (total_epochs=2)
#    - rlad_alpha=1.0, rlad_c=1.5
# ============================================================
set -x
...
python3 -m verl.trainer.main_ppo \
        ...
        trainer.experiment_name='RLAD_30Bto4B_T1.0_alpha1.0_c1.5' \
        trainer.n_gpus_per_node=8 \
        trainer.nnodes=1 \
        trainer.save_freq=20 \
        trainer.test_freq=10 \
        trainer.default_local_dir=/G-OPD-checkpoints/RLAD-30Bto4B \
