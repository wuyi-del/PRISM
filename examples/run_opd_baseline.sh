#!/bin/bash
# ============================================================
#  OPD Baseline (Standard On-Policy Distillation)
#  Strong-to-Weak (30B → 4B)
#
#  This script runs vanilla OPD without PRISM modulation,
#  serving as the primary baseline for comparison.
# ============================================================
set -x
...
CHECKPOINT_DIR=/path/to/checkpoints/OPD-Baseline-30Bto4B
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='OPD_Baseline_30Bto4B_seed42' \
