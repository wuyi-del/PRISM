...
#
#  Configuration:
#    - Teacher: Qwen3-4B-Non-Thinking-RL-Math (RL-finetuned)
#    - Student: Qwen3-4B (base, Non-Thinking mode)
...
TEACHER_MODEL=/path/to/Qwen3-4B-Non-Thinking-RL-Math
TRAIN_DATA=../G-OPD-Training-Data/DeepMath-103K/train_filtered_level6.parquet
CHECKPOINT_DIR=/path/to/checkpoints/PRISM-4Bto4B
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='PRISM_4Bto4B_DeepMath_seed42' \
